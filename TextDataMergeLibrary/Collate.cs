...
namespace TextDataMergeLibrary
{
        ...
        TextFunctionBase
    {
        ...
        /// <returns></returns>
        public Boolean Equals(Collate other)
        {
        ...
        public override Boolean Valid()
        {
            ...
            try
            {
                ...
                {
                    returnValue = false;
                    ErrorMessage = String.Format("OutputFiles must contain at least one file.");
                }
                else
                {
                    returnValue = true;
        ...
        public override Boolean AddOutputFile(String filePath)
        {
            ...
            try
            {
                returnValue = AddFile<ConditionedDataFile>(filePath, this.OutputFiles, new ConditionedDataFile(filePath, new Condition(filePath, false, "<", "")), false);
            }
            catch (Exception ex)
            {
                Log.Write(ex, MethodBase.GetCurrentMethod(), EventLogEntryType.Error);
        ...
        public override Boolean Run()
        {
            ...
            try
            {
                ...
                foreach (String line in strings)
                {
                    ...
                    {
                        //TODO:this looks like a candidate for PLINQ
